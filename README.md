...
AI-powered platform that helps students build ATS-friendly resumes, practice mock interviews, receive AI-generated feedback, and improve communication skills.

---

### 🥗 AI Diet & Fitness Tracker

A healthcare application designed for chronic disease management that provides personalized diet recommendations, workout plans, medication reminders, and AI-powered health insights.

---

### 🛒 Swiggy Grocery Subscription UX

Designed an intuitive grocery subscription experience with personalized plans, seamless checkout flow, and improved user experience using Figma.

---

### 🎓 EduGramix (Smart India Hackathon)

An educational platform designed for rural diploma colleges with offline-first support, low-bandwidth optimization, and student-centric UI.

---

# 🏅 Achievements

🏆 Smart India Hackathon 2025 – Selected to Level 2

💜 IEEE Computer Society Chapter Member

🎤 Event Coordinator – WebCraft

🤖 AI Intern – Skill Dzire Technologies Pvt. Ltd.
...
![](https://github-profile-trophy.vercel.app/?username=23K61A05C4&theme=tokyonight&no-frame=true&margin-w=10)
